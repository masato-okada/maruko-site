<?php include __DIR__ . '/includes/header-chemical.php'; ?>

<div class="theme-chemical">
  ...
  <section class="page-content">
    <div class="container">
      <div class="content-section">
        <p class="lead-text">
          理化学器械事業に関するお問い合わせ・ご相談は、以下のフォームより
          お気軽にご連絡ください。
        </p>
      </div>
      ...
      <div class="contact-section contact-section-form-only">
        <div class="contact-form">
          ...
          <form action="/chemical-contact.php" method="post" class="form">
